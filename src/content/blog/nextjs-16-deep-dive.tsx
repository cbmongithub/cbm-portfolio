    ...
    <div className="space-y-6">
      ...
      <section className="space-y-2">
        ...
        <List>
          ...
          <li>
            <strong>React Compiler support</strong> - Automatic memoization without
            lifting a finger
          </li>
          <li>
            <strong>Build Adapters API</strong> - For deployment platforms to hook into
            the build process
          </li>
          <li>
          ...
          <li>
            <strong>New caching APIs</strong> - <InlineCode>updateTag()</InlineCode> and
            an updated <InlineCode>revalidateTag()</InlineCode>
          </li>
          <li>
...
npx create-next-app@latest`}
        />
        <Text>
          The codemod is pretty smart, but for edge cases, you'll want to check out the
          full upgrade guide in the docs.
        </Text>
      </section>
      ...
      <section className="space-y-2">
        ...
        <Text>
          Now, everything is dynamic by default. Pages, layouts, and API routes all
          execute at request time unless you explicitly cache them. This is a huge win for
          developer expectations - what you write is what runs, no surprises.
        </Text>
        <Text>
          But here's where it gets really interesting: Cache Components complete the
          vision of Partial Pre-Rendering (PPR) that the team introduced back in 2023.
          Before PPR, you had to choose whether a route was static or dynamic - there was
          no middle ground. PPR let you mix static and dynamic content on the same page
          using Suspense boundaries, but now Cache Components give you fine-grained
          control over exactly what gets cached and for how long.
        </Text>
...
export default nextConfig;`}
        />
        <Text>
          The team is planning to share more details at Next.js Conf, and I'm expecting
          deep dives in the docs soon. This is definitely a feature worth paying attention
          to.
        </Text>
        <Quote>
          <strong>Important note:</strong> The old{" "}
          <InlineCode>experimental.ppr</InlineCode> flag is gone. Cache Components is the
          new way forward, so if you were using PPR in beta, you'll need to migrate.
        </Quote>
      </section>
      ...
      <section className="space-y-2">
        ...
        <List>
          <li>
            <strong>Understand your Next.js app</strong> - They know about routing,
            caching, and rendering behaviors specific to Next.js
          </li>
          <li>
          ...
          <li>
            <strong>Read your errors automatically</strong> - Stack traces get sent to
            your AI assistant without you copying and pasting
          </li>
          <li>
      ...
      <section className="space-y-2">
        ...
        <Text>
          Okay, this one might seem like just a rename, but there's a good reason behind
          it. The file formerly known as <InlineCode>middleware.ts</InlineCode> is now{" "}
  ...
  return NextResponse.redirect(new URL('/home', request.url));
        ...
        <Text>
          ...
          <InlineCode>proxy</InlineCode>, and you're done. The logic stays exactly the
          same.
        </Text>
        <Quote>
 ...
 ✓ Finalizing page optimization in 5ms`}
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          anything - it just works. But if you have custom webpack configuration that
          you're not ready to migrate, you can opt back into webpack:
        </Text>
        <CodeBlock
          language="bash"
          title="terminal"
...
export default nextConfig;`}
        ...
        <Text>
          ...
          productivity gains are real. Give it a try and let the team know how it works
          for you.
        </Text>
      </section>
      ...
      <section className="space-y-2">
        ...
        <Text>
          The React Compiler has been a hot topic in the React community, and Next.js 16
          now has stable support for it.
        </Text>
        <Text>
          ...
          <InlineCode>useCallback</InlineCode>, or <InlineCode>React.memo</InlineCode>{" "}
          calls - the compiler handles optimization for you.
        </Text>
        <Text>
...
export default nextConfig;`}
        ...
        <Text>
          ...
          re-renders, this is worth experimenting with. Just be aware of the trade-offs in
          build time.
        </Text>
      </section>
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          sharing the same layout. In previous versions, Next.js would prefetch that
          shared layout 50 times - once for each link.
        </Text>
        <Text>
...
revalidateTag('blog-posts');`}
        ...
        <Text>
          The team recommends using <InlineCode>'max'</InlineCode> for most use cases,
          which gives you the longest cache lifetime with background revalidation.
        </Text>
      </section>
...
export async function updateUserProfile(userId: string, profile: Profile) {
  ...
  updateTag(\`user-\${userId}\`);
        ...
        />
        <Text>
          Use this for forms, user settings, and any interactive feature where users
          expect to see their changes instantly. Think profile updates, shopping cart
...
export async function markNotificationAsRead(notificationId: string) {
  ...
  refresh();
        ...
        <Text>
          ...
          metrics, or status indicators without invalidating your entire page cache.
        </Text>
      </section>
      ...
      <section className="space-y-2">
        ...
        <List>
          <li>
            <strong>View Transitions</strong> - Native browser transitions for smoother
          ...
          <li>
            ...
            - Hide UI with <InlineCode>display: none</InlineCode>
        ...
        <Table>
          ...
          <tbody>
            ...
            <Tr>
              ...
              <Td>
                <InlineCode>cookies()</InlineCode>, <InlineCode>headers()</InlineCode>,
                and <InlineCode>draftMode()</InlineCode> must all be awaited now.
              </Td>
            </Tr>
          </tbody>
        </Table>
        ...
        <Table>
          ...
          <tbody>
            <Tr>
              ...
              <Td>
                Turbopack is now the default. Add <InlineCode>--webpack</InlineCode> to
                your commands if you need to opt out.
              </Td>
            </Tr>
            <Tr>
              <Td>
            ...
            <Tr>
              ...
              <Td>
                The <InlineCode>16</InlineCode> size was removed from defaults (only 4.2%
                of projects used it).
              </Td>
            </Tr>
            <Tr>
              ...
              <Td>
                Now defaults to 75 instead of allowing 1-100. Quality values are coerced
                to the closest value in <InlineCode>images.qualities</InlineCode>.
              </Td>
            </Tr>
          </tbody>
        </Table>
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          carefully. The async params and server functions change is the biggest one -
          it'll require code changes throughout your app. The automated codemod will help,
          but you'll likely need to do some manual cleanup.
        </Text>
        <Text>
          ...
          and <InlineCode>refresh()</InlineCode> - choosing the right one for each use
      ...
      <section className="space-y-2">
        ...
        <Text>
          The Next.js team is actively looking for feedback on this release. If you run
          into issues or have thoughts on the new features, here's where to share:
        </Text>
        <List>
          <li>
            <Link
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          performance, caching, and developer experience. The move to make Turbopack the
          default, the introduction of Cache Components, and the new caching APIs all
          point toward a more explicit, predictable framework.
        </Text>
        <Text>
        ...
        <Text>
          ...
          Rich, Ismael, and Joseph) for putting this together. And of course, thanks to
          the 3,000+ contributors who've made Next.js what it is today.
        </Text>
