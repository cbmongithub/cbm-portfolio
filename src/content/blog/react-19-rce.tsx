    ...
    <div className="space-y-6">
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          server. No authentication required. No special permissions needed. Just a
          crafted HTTP request to any React Server Function endpoint.
        </Text>
        ...
        <List>
          ...
          <li>
            <strong>It's remote</strong> - They can exploit it from anywhere on the
            internet
          </li>
          <li>
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          vulnerabilities - publishing exploit details too early gives attackers a
          blueprint before defenders can patch.
        </Text>
      </section>
...
npm install next@16.1.0-canary.19`}
        ...
        <Quote>
          ...
          <InlineCode>next@14.2.35</InlineCode>. Yes, this is a major version bump, but
          it's necessary for the security patch.
        </Quote>
        <Text>
          If you're on a canary release like{" "}
          <InlineCode>next@14.3.0-canary.77</InlineCode> or later, downgrade to the latest
          stable 14.x release:
        </Text>
...
npm install react@latest react-dom@latest react-server-dom-webpack@latest`}
        ...
        <Text>
          If you're using React Server Components without a framework, update these
          packages directly:
        </Text>
        <CodeBlock
          language="bash"
...
npm install react@latest react-dom@latest react-server-dom-turbopack@latest`}
        ...
        <Text>
          ...
          server-dom packages. However, if you're in a monorepo that includes web apps
          with Server Components, you need to update only the affected packages:
        </Text>
        <CodeBlock
          language="bash"
          title="terminal"
...
npm install react-server-dom-turbopack@latest`}
        ...
        <Text>
          ...
          cause version mismatch errors. You only need to update the server-dom packages
      ...
      <section className="space-y-2">
        ...
        <Text>
          Several hosting providers (including Vercel, Netlify, and others) worked with
          the React team to deploy temporary mitigations at the infrastructure level. This
          is great, and it shows the community coming together to protect users.
        </Text>
        <Text>
          <strong>However</strong>, you should not rely on these mitigations as your
          primary defense. They're temporary measures, and they might not catch every
          exploit variant. Update your code. Deploy the patched versions. Don't assume
          your hosting provider has you covered.
        </Text>
      </section>
      ...
      <section className="space-y-2">
        ...
        <List as="ol">
          <li>
            <strong>Check your package.json</strong> - Make sure the updated versions are
      ...
      <section className="space-y-2">
        ...
        <Text>
          This is a remarkably fast response time for a vulnerability of this severity.
          From discovery to public patch in just four days is impressive, and it shows how
      ...
      <section className="space-y-2">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <Text>
              In theory, yes. In practice, if you're using a framework like Next.js with
              the App Router, Server Components are deeply integrated. Disabling them
              would require significant code changes. It's faster and safer to just
              update.
            </Text>
          </div>
          <div className="space-y-2">
            ...
            <Text>
              This is the scary part: exploitation might not leave obvious traces. Check
              your server logs for unusual HTTP requests to Server Function endpoints,
              unexpected process spawning, or unusual network activity. If you're
              seriously concerned, consider engaging a security professional for a
              thorough audit.
            </Text>
          </div>
          <div className="space-y-2">
            ...
            <Text>
              ...
              transparency is usually the right call. You don't need to provide exploit
              details, but letting users know you've addressed a security issue builds
              trust.
            </Text>
          </div>
          <div className="space-y-2">
            ...
            <Text>
              Probably. Server Components are relatively new technology, and as they get
              more usage and scrutiny, more vulnerabilities may be discovered. This is
              normal for evolving software. The key is having processes in place to
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          coordinating a rapid response. Getting patches out across the entire ecosystem
          in four days is no small feat.
        </Text>
      </section>
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          repeating: if you're using React Server Components in production, stop reading
          and go patch your apps.
        </Text>
      ...
      <section className="space-y-2">
        ...
        <Text>
          ...
          vulnerabilities like this are disclosed. The faster you can patch, the safer
          your users are.
        </Text>
      </section>
    </div>
